        ...
        <div className="bg-white dark:bg-gray-900">
          ...
          <nav className="border-gray-200 bg-white dark:bg-gray-900">
            <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-3">
              ...
              >
                ...
                <DarkThemeToggle className="block justify-end rounded px-3 py-2" />
              </div>
            </div>
          </nav>
          ...
          <div>
            <div className="flex flex-wrap">
              {/* product no.1 */}
              <div className="w-full p-10 sm:w-1/2 lg:w-1/3">
                <div className="flex size-full max-w-sm flex-col rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <div className="px-5 pb-5">
                    ...
                    <div className="mb-5 mt-2.5 flex items-center">
                      <div className="flex items-center space-x-1 rtl:space-x-reverse">
                        ...
                        <svg
                          className="size-4 text-gray-200 dark:text-gray-600"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="currentColor"
                          viewBox="0 0 22 20"
          ...
          <h1 className="mb-4 p-10 text-center text-4xl font-extrabold leading-none tracking-tight text-white dark:text-white md:text-5xl lg:text-6xl">
            Our happy customers:
          </h1>
          <div
            id="default-carousel"
